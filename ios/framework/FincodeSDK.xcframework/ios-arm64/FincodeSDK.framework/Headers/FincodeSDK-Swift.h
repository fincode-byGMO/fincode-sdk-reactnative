...
#ifndef FINCODESDK_SWIFT_H
#define FINCODESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FincodeSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface FincodeCommon : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
/// 見出しの表示・非表示を設定します
/// true: 表示
/// false: 非表示
@property (nonatomic) IBInspectable BOOL headingHidden;
/// ブランド画像 動的切り替えの表示・非表示を設定します
/// true: 表示
/// false: 非表示
@property (nonatomic) IBInspectable BOOL dynamicLogDisplay;
/// 名義人名の表示・非表示を設定します
/// true: 表示
/// false: 非表示
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC10FincodeSDK21FincodeHorizontalView")
@interface FincodeHorizontalView : FincodeCommon
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC10FincodeSDK19FincodeVerticalView")
@interface FincodeVerticalView : FincodeCommon
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10FincodeSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(FincodeSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FincodeSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FincodeSDK)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(FincodeSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC10FincodeSDK12TaskDelegate")
...
@interface UITextField (SWIFT_EXTENSION(FincodeSDK))
/// プレイスホルダーの色を設定
@property (nonatomic, strong) IBInspectable UIColor * _Nullable placeholderColor;
@end


@interface UIView (SWIFT_EXTENSION(FincodeSDK))
/// 角の丸みを取得・設定
...
/// 背景色を取得・設定
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull extBackgroundColor;
@end
