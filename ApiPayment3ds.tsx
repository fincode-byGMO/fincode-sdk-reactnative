...
const sample_tds2BillAddrCity = '';
const sample_tds2BillAddrCountry = '';
const sample_tds2BillAddrLine1 = '';
const sample_tds2BillAddrLine2 = '';
const sample_tds2BillAddrLine3 = '';
const sample_tds2BillAddrPostCode = '';
const sample_tds2BillAddrState = '';
const sample_tds2Email = '';
const sample_tds2HomePhoneCc = '';
const sample_tds2HomePhoneNo = '';
...
const sample_tds2ShipAddrCountry = '';
const sample_tds2ShipAddrLine1 = '';
const sample_tds2ShipAddrLine2 = '';
const sample_tds2ShipAddrLine3 = '';
const sample_tds2ShipAddrPostCode = '';
const sample_tds2ShipAddrState = '';
