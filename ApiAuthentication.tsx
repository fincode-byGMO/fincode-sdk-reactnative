...
import { FincodeVerticalView, AuthenticationResponse, FincodeErrorResponse, BEARER, authentication, ErrorResponse } from './fincode_component/Fincode';
