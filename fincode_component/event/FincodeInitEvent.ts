...
import {
  ...
  ApiKonbiniSuccessCallback,
  ApiPaypaySuccessCallback,
...
// API単体実行: 決済実行(コンビニ決済)
let apiKonbiniSuccessCallback: ApiKonbiniSuccessCallback;

export const konbini = (req: KonbiniRequest, successCallback: ApiKonbiniSuccessCallback, failureCallback: ApiFailureCallback) => {
  apiKonbiniSuccessCallback = successCallback;
  apiFailureCallback = failureCallback;
...
const apiKonbiniSuccess = (
  ...
  apiKonbiniSuccessCallback({
    ...
    konbiniStoreCode: konbiniStoreCode,
    errorCode: errorCode,
    overpaymentFlag: overpaymentFlag,
    cancelOverpaymentFlag: cancelOverpaymentFlag,
    created: created,
    updated: updated,
  });
};
...
// API単体実行: 決済実行(PayPay)
let apiPaypaySuccessCallback: ApiPaypaySuccessCallback;

export const paypay = (req: PaypayRequest, successCallback: ApiPaypaySuccessCallback, failureCallback: ApiFailureCallback) => {
  apiPaypaySuccessCallback = successCallback;
  apiFailureCallback = failureCallback;
  apiModule.paypay(req.authorization, req.apiKey, req.apiVersion, req.payType, req.accessId, req.id, req.customerId, req.redirectUrl, req.redirectType, req.userAgent, apiFailure, apiPaypaySuccess);
};

const apiPaypaySuccess = (
  shopId: string,
  id: string,
  payType: string,
  status: string,
  ...
  apiPaypaySuccessCallback({
    ...
    codeUrl: codeUrl,
    paymentId: paymentId,
    paypayResultCode: paypayResultCode,
    merchantPaymentId: merchantPaymentId,
    merchantCaptureId: merchantCaptureId,
    merchantUpdateId: merchantUpdateId,
